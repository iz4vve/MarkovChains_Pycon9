...
%    				$$
	...
	\uncover<2->{
		The transition matrix will be of size $N(N-1) \times N(N-1)$, where $N$ is the cardinality of the set of possible states, and it will relate pairs of states instead of single states.\\
	...
	\begin{center}
	\href{localhost:8888/tree}{\structure{\Huge{Demo!}}}
	\end{center}
	\end{frame}
